...
```{r}
n_gen = 4000 #number of generations
n_sims = 500 #number of chains
p_theta = 0.5 #initial p_theta value
...
file_path = '../Sims Data/speaker_.01_listener_.009_ngen4000.csv'
...
write_csv(new_df, '../Sims Data/speaker_.01_listener_.009_ngen4000.csv')

} else {
new_df = read_csv('../Sims Data/speaker_.01_listener_.009_ngen4000.csv')
}
